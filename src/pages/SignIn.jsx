  ...
  return (
    <main className="h-screen overflow-hidden flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full px-12 pb-12 text-center">
          <h2
          ...
          <p className="text-white text-sm leading-relaxed font-semibold max-w-xs mx-auto">
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-6">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-center text-dark font-bold text-lg mb-4">Login your Account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <a href="#" className="text-[#FF7A18] text-xs font-medium mt-1 block text-right hover:underline">
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#FF7A18] hover:bg-[#e66e16] text-white font-semibold py-2.5 rounded-xl transition-colors text-sm"
            >
              Sign In
            </button>
          </form>
          ...
          <p className="text-center text-gray-500 text-xs mt-3">
            ...
            <Link to="/signup" className="text-[#FF7A18] font-semibold hover:underline">
              Sign Up
            </Link>
          </p>
